/**
 * Solution class provides methods to count the number of jewels in a set of stones.
 */
class Solution {
    /**
     * Counts the number of jewels in the given set of stones.
     * 
     * Time Complexity: O(m + n), where 'm' is the length of the string jewels and 'n' is the length of the string stones.
     *                   Converting jewels to a set takes O(m) time, and iterating through stones takes O(n) time.
     * 
     * Space Complexity: O(m), where 'm' is the length of the string jewels. The space used is proportional to the number
