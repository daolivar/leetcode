/**
 * Solution class provides a method to convert temperature from Celsius to Kelvin and Fahrenheit.
 */
class Solution {
    /**
     * Converts temperature from Celsius to Kelvin and Fahrenheit.
     * 
     * Time Complexity: O(1), as the conversion involves basic arithmetic operations that are constant time.
     * 
