/**
 * Solution class provides a method to find the smallest even multiple of a
 * given integer.
 */
class Solution {
    /**
     ...
     * @return The smallest even multiple of the input integer. If the input is
     *         already even, returns the input itself.
     */
